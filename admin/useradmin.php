...
<form action="./?mod=useradmin" method="POST">
	...
	<div class="formnama">
		...
		<input type="text" name="nama" placeholder="Nama Lengkap" value="<?=(isset($nama) ? $nama : '');?>" required>
	</div>
	...
	<div class="formnama">
		...
		<input type="text" name="email" placeholder="Email address" value="<?=(isset($email) ? $email : '');?>" required>
	</div>
